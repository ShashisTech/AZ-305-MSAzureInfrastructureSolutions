# **[Designing a Scalable Azure Compute Solution for a 3‑Tier Application]{.underline}**
...
## Step 3: Front-end Tier → Azure App Service {#step-3-front-end-tier-azure-app-service}
...
## Step 4: Orders & Catalog → Azure SQL Database (Managed Instance) {#step-4-orders-catalog-azure-sql-database-managed-instance}
...
## Step 5: Support Requests → Azure Service Bus (Queue) {#step-5-support-requests-azure-service-bus-queue}
...
## Step 6: Middle Tier → Azure Functions {#step-6-middle-tier-azure-functions}
...
## Step 7: Supporting Services (Observability & Security) {#step-7-supporting-services-observability-security}
...
##  Final Answer to the Tasks {#final-answer-to-the-tasks}
...
##  Azure Well-Architected Framework (WAF) {#azure-well-architected-framework-waf}
